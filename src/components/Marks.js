        ...
        return (
          <>
            {counties.features.map(feature => {
              ...
              return <path className="county" data-fips={feature.id} data-education={bachelorsValue} fill={colorScale(bachelorsValue)} d={path(feature)} key={feature.id} onMouseOver={e => onMouseOver(e, feature.id)} onMouseOut={e => onMouseOut()} />
            })}
